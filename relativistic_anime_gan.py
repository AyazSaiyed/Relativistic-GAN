# -*- coding: utf-8 -*-
"""Relativistic Anime GAN.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1oOSwgxH6zwYFcPyoe1mkJq1GNh3NzjL1
"""
...
# import zipfile
# with zipfile.ZipFile('/var/tmp/ResizedNEW512.zip', 'r') as zip_ref:
#     zip_ref.extractall('/')
...
def show_generated_img():
    ...
    # gen_images = gen_image.numpy().transpose(1, 2, 0)
    # img = Image.open(gen_images)
    # Image.save("a.jpg") 
    # plt.imshow((gen_images+1)/2)
    # plt.show()
    # plt.savefig('a.png')
    ...
    if i < 1:
      ...
      b = str(a)
      # plt.savefig(b+'.png')
      # rgb = scipy.misc.toimage(gen_images)
      # image = PIL.Image.fromarray(gen_images)
      # image.save(b+".png") 
      save_image(gen_image,"q"+b+".png")
#       cv2.imwrite(b+'.png',gen_images)
...
for epoch in range(epochs):
    for ii, real_images in tqdm(enumerate(train_loader), total=len(train_loader)):
        ...
        if (ii+1) % (len(train_loader)//2) == 0:
            print('[%d/%d][%d/%d] Loss_D: %.4f Loss_G: %.4f'% (epoch + 1, epochs, ii+1, len(train_loader),errD.item(), errG.item()))
    show_generated_img()
